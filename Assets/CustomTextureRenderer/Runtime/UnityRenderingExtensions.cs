// This code is ported from Low-level Native Plugin Rendering Extensions.

namespace UnityCustomTextureRenderer
{
    public unsafe struct UnityRenderingExtTextureUpdateParamsV2
    {
        public void* texData;                          // source data for the texture update. Must be set by the plugin
        public long textureID;                         // texture ID of the texture to be updated.
        public uint userData;                          // user defined data. Set by the plugin
        public UnityRenderingExtTextureFormat format;  // format of the texture to be updated
        public uint width;                             // width of the texture
        public uint height;                            // height of the texture
        public uint bpp;                               // texture bytes per pixel.
    }

    public enum UnityRenderingExtEventType
    {
    ...
    public enum UnityRenderingExtTextureFormat
    {
